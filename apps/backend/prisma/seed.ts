  ...
  const spots = [
    {
      ...
      averageVisibilityMeters: 7.8,
      averageRating: 4.4,
      reportCount: 12,
      latestReportAt: new Date('2026-01-10T09:30:00.000Z'),
      parkingLocations: [
    ...
    },
    {
      ...
      averageVisibilityMeters: 6.1,
      averageRating: 4.0,
      reportCount: 4,
      latestReportAt: new Date('2026-02-20T12:15:00.000Z'),
      parkingLocations: [
        { lat: 59.9102, lon: 10.7275, label: 'Aker Brygge ferry terminal' },
      ],
    },
    ...
    },
    {
      ...
      averageVisibilityMeters: 8.9,
      averageRating: 4.7,
      reportCount: 18,
      latestReportAt: new Date('2026-02-22T15:00:00.000Z'),
      parkingLocations: [
    ...
    },
    {
      ...
      averageVisibilityMeters: 5.4,
      averageRating: 3.9,
      reportCount: 6,
      latestReportAt: new Date('2025-11-05T08:45:00.000Z'),
      parkingLocations: [
